function pass_func(template_values_curr) {
    $(document).ready(function() {
            ...
            $('.modal-footer button#submit').on('click', function(e){
                ...
                var link="/Notices/EditGeneralNotice?msg="+txt+"&id="+id;
            ...
            updated_prev_page_url = "/Notices/MyGeneralNotices?page=" + (init_page_num-1).toString();
            $("#pageprev").attr("href", updated_prev_page_url);

            updated_next_page_url = "/Notices/MyGeneralNotices?page=" + (init_page_num+1).toString();
