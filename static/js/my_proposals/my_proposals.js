                        ...
                        project_list.forEach(function(project, index) {
                                $("#projects").append(
                                        '<li class="list-group-item">' +
                                                ...
                                                '<button type="button" name="edit_button" class="btn btn-primary float-right">Düzenle</button>' +
                                                '<button type="button" name="delete_button" class="btn btn-danger float-right mr-3">Sil</button>' +
                                        '</li>'
                                );
                        });
